...
@CucumberOptions(
    ...
    {
        "pretty",
        "html:target/CucumberHTMLReport/my_amaysim/my_settings/ms008",
        "json:target/CucumberHTMLReport/my_amaysim/my_settings/ms008/cucumber-report.json"
    },
    snippets = SnippetType.CAMELCASE)
public class TestMySettings extends BaseTest { 
